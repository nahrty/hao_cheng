...
Blances = [0.0 for i in range(marketLength)]
buyOrders = [[]for i in range(marketLength)]
sellOrders = [[]for i in range(marketLength)]

#初始化apikey，secretkey,url
apikey = '3f870846-4fdc-4f60-a643-248b304633e9'
secretkey = 'CEF39139D4C86EFEE9470198090A9333'
okcoinRESTURL = 'www.okex.cn'   #请求注意：国内账号需要 修改为 www.okcoin.cn  
...
#print (u' 现货行情 ')
#print (okcoinSpot.ticker('xrp_usdt'))

#print (u' 现货深度 ')
#print (okcoinSpot.depth('xrp_usdt'))
